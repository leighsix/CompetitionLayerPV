...
class ChangingVariable:
    def __init__(self, setting, p=(0, 1), v=(0, 1), gap=30, select_using_prob=(True, False), steps=(1, 2),
                 select_node_layers=(0, 0), select_node_methods=(0, 0), node_numbers=(0, 0), unchanged_state=-1,
    ...
    def calculate_for_simulation(setting_variable_tuple):
        repeat_result = RepeatDynamics.RepeatDynamics(setting_variable_tuple[0], setting_variable_tuple[1], setting_variable_tuple[2],
                                                      ...
                                                      select_node_layer=setting_variable_tuple[5], select_node_method=setting_variable_tuple[6],
